...
- This table records the initial pilot, not current route acceptance. Later screens are reviewed against the layout contract in README.md: preserve major regions and actions, test semantics and responsiveness, and do not require pixel parity or a signed screenshot baseline.
