...
import { EmergencyContactsPage } from "./EmergencyContactsPage.js";
...
function renderPage(state: PageState): Promise<string> {
  return Promise.resolve(
    renderToStaticMarkup(createElement(EmergencyContactsPage, { state })),
  );
}
